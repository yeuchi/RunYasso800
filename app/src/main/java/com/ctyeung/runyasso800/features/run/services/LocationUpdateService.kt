package com.ctyeung.runyasso800.features.run.services
...
import com.ctyeung.runyasso800.features.run.stateMachine.StateMachine
...
class LocationUpdateService : Service(), IRunStatsCallBack {
    ...
    override fun onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val name: CharSequence = "runyasso800"
    ...
    fun getNotification(): Notification {
        ...
        val builder =
            NotificationCompat.Builder(this)
                ...
                .addAction(
                    R.drawable.ic_cancel, "Remove location updates",
...
//                .setSmallIcon(R.mipmap.ic_launcher)
    ...
    private fun createLocationRequest() {
        ...
        val interval = SharedPrefUtility.get(
            SharedPrefUtility.keyGPSsampleRate,
            DEFAULT_SAMPLE_RATE
        ) * MILLI_SECOND
